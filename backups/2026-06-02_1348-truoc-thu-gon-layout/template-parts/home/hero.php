...
<section class="hero-cta" id="hero-cta">
  <div class="hero-cta__inner">
    <p class="hero-cta__tagline">Become inspiring leaders to lead the change</p>
    <div class="hero-cta__btns">
      <a href="#what-we-do" class="hero-cta__btn">Join Customized Leadership Program</a>
      <a href="#what-we-do" class="hero-cta__btn hero-cta__btn--outline">Join Programs for Team members</a>
    </div>
  </div>
</section>
