...
add_action('init', function () {
    ...
    if (get_option('tnl_rewrite_v') !== '3') {
        flush_rewrite_rules(false);
        update_option('tnl_rewrite_v', '3');
    }
});
...
/* URL chuyển ngôn ngữ: dạng path /en/ /vi/ (giống live) */
...
function tnl_strings() {
    return [
        'en' => [
            ...
            // testimonials
            'tm_title' => 'Our leaders say about<br>the experience',
        ...
        'vi' => [
            ...
            // testimonials
            'tm_title' => 'Đánh giá của các nhà lãnh đạo<br>về khoá học của chúng tôi',
