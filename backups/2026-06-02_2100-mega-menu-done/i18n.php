        ...
        return [
            ['label' => 'Sản phẩm & Dịch vụ', 'slug' => 'our-services', 'columns' => [
                ['heading' => ['label' => 'Chương trình đào tạo', 'slug' => 'our-services'], 'items' => [
                    ['label' => 'Dành cho quản lý', 'slug' => 'our-services'],
                    ['label' => 'Dành cho đội nhóm', 'slug' => 'our-services'],
                    ['label' => 'Coaching cho lãnh đạo', 'slug' => 'our-services'],
                    ['label' => 'Khóa cá nhân', 'slug' => 'our-services'],
                ]],
    ...
    return [
        ['label' => 'Our Services & Products', 'slug' => 'our-services', 'columns' => [
            ['heading' => ['label' => 'Training programs', 'slug' => 'our-services'], 'items' => [
                ['label' => 'For Leader/Manager', 'slug' => 'our-services'],
                ['label' => 'For Team member', 'slug' => 'our-services'],
                ['label' => 'Executive coach', 'slug' => 'our-services'],
                ['label' => 'Individual courses', 'slug' => 'our-services'],
            ]],
