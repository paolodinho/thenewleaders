    ...
    <div class="container">
      ...
      <div class="ec-tm__grid">
        <?php foreach ($P['people'] as $p) : ?>
          <figure class="ec-quote"><blockquote><?php echo esc_html($p['q']); ?></blockquote><figcaption><span class="ec-quote__name"><?php echo esc_html($p['n']); ?></span><span class="ec-quote__role"><?php echo esc_html($p['r']); ?></span></figcaption></figure>
        <?php endforeach; ?>
      </div>
    </div>
  </section>
