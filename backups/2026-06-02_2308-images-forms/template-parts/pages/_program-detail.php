...
<main class="site-main page-program">
  ...
  <section class="pg-hero section">
    <div class="container">
      ...
      <?php if (!empty($P['hero_cta'])) : ?><span class="pg-hero__cta"><?php echo esc_html($P['hero_cta']); ?></span><?php endif; ?>
  ...
  <section class="pg-impact2 section">
    <div class="container">
      ...
      <div class="pg-impact2__grid">
        <?php foreach ($P['impact_blocks'] as $b) : ?>
          <div class="pg-impact2__card">
    ...
    <div class="container">
      ...
      <ol class="pg-modules">
        <?php foreach ($P['modules'] as $i => $m) : ?>
          <li class="pg-module">
            <span class="pg-module__num"><?php printf('%02d', $i + 1); ?></span>
  ...
  <section class="pg-whyus section">
    <div class="container">
      ...
      <div class="pg-whyus__grid">
        <?php foreach ($P['whyus'] as $w) : ?>
          <div class="pg-whyus__card">
