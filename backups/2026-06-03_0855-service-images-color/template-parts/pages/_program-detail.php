...
<main class="site-main page-program">
  ...
  <!-- Hero -->
  <section class="pg-hero section<?php echo !empty($P['hero_img']) ? ' pg-hero--media' : ''; ?>">
    <div class="container pg-hero__inner">
      ...
      <?php if (!empty($P['hero_img'])) : ?>
        <div class="pg-hero__media"><img src="<?php echo esc_url($P['hero_img']); ?>" alt="<?php echo esc_attr($P['hero_tagline']); ?>" loading="eager"></div>
      <?php endif; ?>
    </div>
  </section>
