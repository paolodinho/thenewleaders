...
<main class="site-main page-service">
  ...
  <section class="pg-hero pg-hero--brand section">
    <div class="container">
      <h1 class="pg-hero__title"><?php echo esc_html($tagline); ?></h1>
      <div class="pg-pills">
        <?php foreach ($pills as $p) : ?><span class="pg-pill pg-pill--ghost"><?php echo esc_html($p); ?></span><?php endforeach; ?>
      </div>
      <a href="<?php echo esc_url($contact); ?>" class="btn pg-hero__cta-btn"><?php echo esc_html($hero_cta); ?></a>
    </div>
  </section>

  <div class="ic-banner">
    <div class="container">
      <figure class="ic-banner__fig"><img src="<?php echo esc_url(get_template_directory_uri() . '/assets/media/cards/individuals.jpg'); ?>" alt="<?php echo esc_attr($tagline); ?>" loading="eager"></figure>
    </div>
  </div>
    ...
    <div class="container">
      ...
      <div class="pg-tm__grid">
        <?php foreach ($people as $i => $p) : ?>
          <?php $av = function_exists('tnl_avatar') ? tnl_avatar($p['n']) : ''; $am=['teal','green','orange','pink']; ?>
          <figure class="pg-quote"><blockquote class="pg-quote__text"><?php echo esc_html($p['q']); ?></blockquote><figcaption class="pg-quote__by">
            <?php if ($av) : ?><span class="pg-quote__avatar"><img src="<?php echo esc_url($av); ?>" alt="<?php echo esc_attr($p['n']); ?>" loading="lazy"></span>
            <?php else : ?><span class="pg-quote__avatar pg-quote__avatar--initials pg-quote__avatar--<?php echo $am[$i%4]; ?>"><?php echo esc_html(tnl_initials($p['n'])); ?></span><?php endif; ?>
            <span class="pg-quote__meta"><span class="pg-quote__name"><?php echo esc_html($p['n']); ?></span><span class="pg-quote__role"><?php echo esc_html($p['r']); ?></span></span>
          </figcaption></figure>
        <?php endforeach; ?>
      </div>
    </div>
