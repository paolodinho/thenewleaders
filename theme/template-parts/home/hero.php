...
<section class="hero-cta" id="hero-cta">
  <div class="hero-cta__inner">
    ...
    <div class="hero-cta__btns">
      <a href="/our-services#business-programs" class="hero-cta__btn"><?php echo tnl_t('hero_btn1'); ?></a>
      <a href="/our-services#individual-programs" class="hero-cta__btn hero-cta__btn--outline"><?php echo tnl_t('hero_btn2'); ?></a>
    </div>
  </div>
</section>
